    ...
    <div className="min-h-screen flex flex-col bg-[#FDFDFE]">
      ...
      <main className="flex-grow flex flex-col lg:flex-row w-full px-10 py-12 gap-10">
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex-1 rounded-2xl bg-[#F5FAFF] border border-[#1F3351]/20 shadow-sm p-5 overflow-y-auto max-h-[60vh]">
            {selected.length === 0 ? (
      ...
      {/* SAVE BUTTON */}
        <div className="flex justify-start px-10 pb-10">
          <button
